...
import { MapPin, Calendar, FolderOpen, Menu, X, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 sm:w-72 bg-sidebar shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
        ...
        <nav className="mt-4 sm:mt-8">
          ...
          <div className="px-2 mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-sidebar-border">
            <Link
              to="/"
              className="group flex items-center px-2 sm:px-3 py-2 sm:py-2.5 text-sm font-medium rounded-md transition-colors text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
            >
              <ArrowLeft className="mr-2 sm:mr-3 h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0" />
            ...
            <div className="flex justify-between h-14 sm:h-16">
              <div className="flex items-center min-w-0 space-x-3">
                ...
                <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  />
                  <div className="h-6 w-6 sm:h-8 sm:w-8 bg-primary rounded-md hidden flex-shrink-0"></div>
